...
<head>
    ...
    <!-- MDB -->
    <link rel="stylesheet" href="{{ url('client/css/mdb.min.css')}}" />
    <!-- Custom styles -->
...
@yield('header')
  ...
  <!--Footer-->
    <!-- MDB -->
    <script type="text/javascript" src="{{ url('client/js/mdb.min.js')}}"></script>
    <!-- Custom scripts -->
    <script type="text/javascript" src="{{ url('client/js/script.js')}}"></script>
</body>
</html>